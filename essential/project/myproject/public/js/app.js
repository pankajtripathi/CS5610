...
app.config(function($routeProvider, $httpProvider) {
    ...
    .when('/MovieDetails', {
     ...
     .when('/MyMovies', {
            templateUrl: 'movieLib/MyMovies.html',
...
app.controller("profileCtrl",
	...
	$scope.myMovie = function (currentUser){
...
app.controller("MyMoviesCtrl",
	...
	$scope.movieDetails = function (movie) {
     ...
     $scope.removeFavMovie = function (m) {  
    	 console.log(m);
    	 var data = m.favMovies.id;
    	 console.log(data);
         $http.delete("/favMovies/"+$scope.currentUser.username+"/"+data)
         .success(function (response) {
         $rootScope.favMovies = response;  
         console.log(response);
         })
